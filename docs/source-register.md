...
- [x] Research topic is narrowly defined.
- [x] Initial corpus contains 10 trusted references.
- [x] Every source has a unique `source_id`.
- [x] Coverage gaps are documented.
